...
const cartButtons = document.querySelectorAll("#productsList .product .btn");
let itemsNumber = document.getElementById("itemsCount");

// console.log(++itemsNumber)

// this increases the number of items in the cart each time the user clicks on the add to cart btn
cartButtons.forEach(cardButton => {
    cardButton.addEventListener("click", e => {
        itemsNumber.innerHTML = `${++itemsNumber.innerHTML}`;
    })
})
